...
def create_deck(game):
    for deck in GAMES[game.name]["decks"]:
        new_deck = models.Deck(game=game)
        new_deck.save()
        for card_name, rules in deck.items():
...
def create_game(game: Game):
    new_game = models.Game(name=game.name, session_name=game.session_name, need_money=GAMES[game.name].get("need_money", False), can_give_cards=GAMES[game.name].get("can_give_cards", False))
    new_game.save()
